package eu.kanade.tachiyomi.animeextension.pt.hazeflix
...
class HazeFlix : ParsedAnimeHttpSource() {
    override val name = "HazeFlix"
    override val baseUrl = "https://hazeflix.is"
