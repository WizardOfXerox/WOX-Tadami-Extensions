package eu.kanade.tachiyomi.animeextension.pt.filmesonlinesh
...
class FilmesOnlineSH : ParsedAnimeHttpSource() {
    override val name = "FilmesOnlineSH"
    override val baseUrl = "https://filmesonline.sh"
