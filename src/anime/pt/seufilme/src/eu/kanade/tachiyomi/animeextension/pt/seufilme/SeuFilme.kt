package eu.kanade.tachiyomi.animeextension.pt.seufilme
...
class SeuFilme : ParsedAnimeHttpSource() {
    override val name = "SeuFilme"
    override val baseUrl = "https://seufilme.net"
