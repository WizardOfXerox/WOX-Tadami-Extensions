package eu.kanade.tachiyomi.animeextension.pt.loveflix
...
class LoveFlix : ParsedAnimeHttpSource() {
    override val name = "LoveFlix"
    override val baseUrl = "https://loveflix.net"
